...
(function ($) {
  ...
  $(document).ready(function () {
    var header = $(".header"),
      ...
      FB_PAGE_EVENTS_ENDPOINT =
        "https://graph.facebook.com/v3.2/1398145177083309/events?callback=?",
      FBAT =
        "EAAC7oBu2ho0BALXKniuwTU9rBMMCFNbpGtTBsSp5zJ6PPMN9yfEsVmPPdSE9FGSVVueWZBJsjX1EHeu3lUjNxgKiWVjptQyj4ZAcF1xvdpMl41YHnrj87Wx7VcoChi6X6QJTdFtAdCU4M9qQzQCM3q7hknrn2DjwXJPZCvjmwZDZD";
    /* ---------------------------------------------- /*
         * Utils
        /* ---------------------------------------------- */
        ...
        $.ajax({
          ...
          success: function (result) {
            ...
            if (result.status === "success") {
              ajaxResponse.html(
                "We've got your message! We will get back to you as soon as we can :)"
              );
              $form.fadeOut(500);
            } else {
              ajaxResponse.html(
    ...
    function createEventsHtml(events, ticket) {
      return events
        .map(function (event) {
          ...
          var html =
            '<div class="row event"><div class="col-1"><div class="date-day">' +
            time.format("DD") +
            '</div><div class="date-month">' +
            time.format("MMM") +
            "</div></div>";
          html +=
            '<div class="col-' +
          ...
          if (ticket)
            html +=
              '<div class="col d-flex justify-content-end"><a class="btn btn-lg" href="' +
              eventFBLink +
              '" target="_blank">Get Tickets</a></div>';
          html += "</div>";
          return html;
        })
        .join("");
        ...
        function (result) {
          ...
          if (result.hasOwnProperty("data") && result.data.length) {
            ...
            eventEl
              ...
              .html(
                "<p>Events coming soon. Follow us on social media to get notified of new events.</p>"
              );
          }
        }
      );
